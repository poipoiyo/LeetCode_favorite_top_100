...
4.  If the current characters are different, dp\[i][j] should be the smallest previous solution +1 because we can remove or replace or add a letter from previous word
