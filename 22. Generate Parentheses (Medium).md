...
3. In solution 2, we record the needed number instead of counting them which shrinks the judgement time.

4. Every string starts with "(". We use "(" instead of "" to accelerate.
