...
#### Ideas : 
 	...
 	2. Since every step increases elements, we can use another deque to memorize the process temporarily. Or we have to record the pop out times if using the same vector.
