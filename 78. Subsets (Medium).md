...
#### Ideas : 
 	...
 	1. Solution 1 is backtracking, similar with problem 46. Focus on start by every element, and remove the last to iterate. 
 	...
 	3. Find out that the answer copied itself and add the new number when the array nums add a new element.
