...
#### Ideas : 
 	...
 	1. Solution 1 uses proiority_queue to sort, but the answer can be accept in any order.
 	...
 	3. In quick select, we pick a targer number and check if the number relationship is correct. Left side of the target should be less frequent and opposite to the right side. 
